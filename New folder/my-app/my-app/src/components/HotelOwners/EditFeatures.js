...
function EditFeatures({open,setOpen,featuresId}) {
...
const SubmitHandler=(e)=>{
    e.preventDefault();
    axios.put(`http://localhost:8080/owner/editFeature/${featuresId}`,initialValues,{
      headers: {
...
<input type ='text' placeholder='hotelOffers' onChange ={(e=> {
  setValues ({...initialValues,
            offers:{...initialValues.offers, hotelDiscount:e.target.value}})
})}/>

       <input type ='text' placeholder='webSiteOffers' onChange ={(e=> {
  setValues ({...initialValues,
            offers:{...initialValues.offers, websiteDiscount:e.target.value}})
})}/>
         <input type ='text' placeholder='hotelOffers' onChange ={(e=> {
  setValues ({...initialValues,
            offers:{...initialValues.offers, more:e.target.value}})
})}/>
